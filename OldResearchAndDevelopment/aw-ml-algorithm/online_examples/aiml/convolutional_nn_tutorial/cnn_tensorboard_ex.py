...
def run_cnn():
    ...
    writer = tf.summary.FileWriter('C:\\Users\\apsw\\ThirdYearGroupProjectGithubRepo\\olympian-biotech\\aw-ml-algorithm\\online_examples\\aiml\\convolutional_nn_tutorial\\tb')
